...
export const BookCheckoutPage = () => {
    ...
    // const authState = userIsAuthenticated();
    ...
    useEffect(() => {
        ...
        const fetchUserCurrentLoansCount = async () => {
            if(userIsAuthenticated()) {
                ...
                const url = config.url.API_BASE_URL + '/api/books/secure/currentloans/count'
    ...
    useEffect(() => {
        const fetchUserCheckedOutBook = async () => {
            if(userIsAuthenticated()) {
                ...
                const url = config.url.API_BASE_URL + `/api/books/secure/ischeckedout/byuser?bookId=${bookId}`;
                const requestOptions = {
                    method: 'GET',
                    headers: {
                        Authorization: `Bearer ${user.accessToken}`,
    ...
    async function checkoutBook() {
        const url = config.url.API_BASE_URL + `/api/books/secure/checkout?bookId=${bookId}`;
        const user = getUser()
