...
export const SearchBooksPage = () => {
    ...
    const [totalAmmountOfBooks, setTotalAmmountOfBooks] = useState(0);
    ...
    let lastItem = booksPerPage * currentPage <= totalAmmountOfBooks ? booksPerPage * currentPage : totalAmmountOfBooks;
            ...
            <div className="container">
                <div>
                    ...
                    {totalAmmountOfBooks > 0 ?
                        <>
                            <div className="mt-3">
                                <h5>Number of results: ({totalAmmountOfBooks})</h5>
                            </div>
                            <p>
